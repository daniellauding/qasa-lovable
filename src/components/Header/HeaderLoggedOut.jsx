            ...
            <nav className="ml-6 hidden lg:block">
              <ul className="flex gap-1">
                <li>
                  ...
                  >
                    <span className="absolute left-0 right-0 top-1/2 h-12 -translate-y-1/2" aria-hidden="true"></span>
                    <span className="group-hover:bg-gray-20/40 scale-80 absolute inset-0 rounded-full transition group-hover:scale-100" aria-hidden="true"></span>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-gray-200 pt-4 pb-4">
            <nav className="space-y-2">
              <a href="/sv/find-home" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md">
                {t('header.homes')}
              </a>
              <a href="/sv/find-tenant" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md">
                {t('header.tenants')}
              </a>
              <a href="/sv/how-it-works" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md">
                {t('header.howItWorks')}
              </a>
            </nav>
