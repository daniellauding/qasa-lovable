...
import RegisterStep2StepByStep from './components/RegisterStep2StepByStep';
import RegisterStep3 from '../components/RegisterStep3';

const RegisterFlowStepByStep = () => {
  ...
  const handleNext = () => {
    if (currentStep < 4) {
      ...
      navigate(`/auth/register/step/${nextStep}?variant=step-by-step`);
  ...
  const handlePrev = () => {
    if (currentStep > 1) {
      ...
      navigate(`/auth/register/step/${prevStep}?variant=step-by-step`);
...
export default RegisterFlowStepByStep; 